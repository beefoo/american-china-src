...
TOP_CENTER = (LENGTH*TOP_CENTER_OFFSET*1.25, 0, 0)
INNER_TOP_CENTER = (LENGTH*TOP_CENTER_OFFSET, 0, 0)

BODY_HEIGHT = 0.575 * (HEIGHT-BASE_HEIGHT)
...
HANDLE_SIDE_BASE_LENGTH = HANDLE_SIDE_LENGTH + 3.0
HANDLE_SIDE_BASE_WIDTH = HANDLE_SIDE_WIDTH + 3.0
HANDLE_SIDE_BASE_HEIGHT = 3.0
HANDLE_SIDE_BULGE_LENGTH_LEFT = 20.0
HANDLE_SIDE_BULGE_LENGTH_RIGHT = 20.0
HANDLE_SIDE_BLUGE_HEIGHT_LEFT = lerp(HANDLE_BOTTOM, HANDLE_TOP, 0.5)
HANDLE_SIDE_BLUGE_HEIGHT_RIGHT = lerp(HANDLE_BOTTOM, HANDLE_TOP, 0.5)
HANDLE_SIDE_BLUGE_MIDHEIGHT_LEFT = lerp(HANDLE_BOTTOM, HANDLE_TOP, 0.2)
HANDLE_SIDE_BLUGE_MIDHEIGHT_RIGHT = lerp(HANDLE_BOTTOM, HANDLE_TOP, 0.2)
...
HANDLE_RIGHT_CENTER_BULGE = (min(HANDLE_RIGHT_CENTER[0]+HANDLE_SIDE_BULGE_LENGTH_RIGHT, LENGTH*0.5), 0, HANDLE_SIDE_BLUGE_HEIGHT_RIGHT)
...
SPOUT_FROM_X = -(LENGTH*BODY_TOP-T2)*0.52 # TODO: define this based on body
SPOUT_INNER_X = -(LENGTH*BODY_TOP-T2)*0.433 # TODO: define this based on body

SPOUT_ROTATE = 20.0
SPOUT_ROTATE_CENTER = ((SPOUT_FROM_X + SPOUT_TO_X) * 0.5, 0.0, SPOUT_CENTER_HEIGHT)
SPOUT_TRANSLATE = (0.0, 0.0, 5.0)
