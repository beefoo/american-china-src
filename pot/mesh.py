...
POT_OUTER_B = [
    ...
    (LENGTH*BODY_TOP_INSET, WIDTH*BODY_TOP_INSET, BODY_HEIGHT-BODY_TOP_INSET_HEIGHT, OUTER_TOP_CENTER_INNER),   # body top inset bottom
    (LENGTH*BODY_TOP_INSET, WIDTH*BODY_TOP_INSET, BODY_HEIGHT, OUTER_TOP_CENTER_INNER),                         # body top inset top
    (LENGTH*BODY_TOP_INSET-EDGE_RADIUS, WIDTH*BODY_TOP_INSET-EDGE_RADIUS, BODY_HEIGHT, OUTER_TOP_CENTER_INNER),          # body top inset top
]
...
TOP_HOLE_WIDTH_INNER = TOP_HOLE_WIDTH - 12.0
TOP_HOLE_LENGTH_INNER = TOP_HOLE_LENGTH - 12.0
TOP_HOLE_OUTER_HEIGHT = BODY_HEIGHT - 7.0
...
SPOUT_TO_X = -(LENGTH*0.95)*0.5 # increase multiplier to make longer
...
outerSpoutCenterZ = SPOUT_CENTER_HEIGHT * 1.1
outerSpoutHeightZ = SPOUT_HEIGHT * 1.0
...
HANDLE_TOP = HEIGHT
HANDLE_SIDE_LENGTH = 10.0
HANDLE_SIDE_WIDTH = 12.0
HANDLE_SIDE_BASE_LENGTH = HANDLE_SIDE_LENGTH + 4.0
HANDLE_SIDE_BASE_WIDTH = HANDLE_SIDE_WIDTH + 4.0
...
HANDLE_TOP_NOTCH_LENGTH = 4.0
HANDLE_TOP_RADIUS_FROM = 8.0
HANDLE_TOP_NOTCH_RADIUS_FROM = HANDLE_TOP_RADIUS_FROM - 2.0
HANDLE_TOP_RADIUS_TO = 9.0
HANDLE_TOP_NOTCH_RADIUS_TO = HANDLE_TOP_RADIUS_TO - 2.0
...
BODY_TOP_INSET_EDGE_X_LEFT = -(LENGTH*BODY_TOP_INSET-EDGE_RADIUS) * 0.5 + OUTER_TOP_CENTER_INNER[0]
TOP_HOLE_X_LEFT = -(TOP_HOLE_LENGTH+TOP_HOLE_EDGE) * 0.5 + TOP_CENTER[0]
BODY_TOP_INSET_EDGE_X_RIGHT = (LENGTH*BODY_TOP_INSET-EDGE_RADIUS) * 0.5 + OUTER_TOP_CENTER_INNER[0]
