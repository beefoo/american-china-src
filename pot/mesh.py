...
HANDLE_TOP = HEIGHT
HANDLE_SIDE_LENGTH = 6.0
HANDLE_SIDE_WIDTH = 12.0
HANDLE_SIDE_BULGE_LENGTH = 20.0
HANDLE_SIDE_BLUGE_HEIGHT = lerp(HANDLE_BOTTOM, HANDLE_TOP, 0.667)
HANDLE_TOP_RADIUS_FROM = 5.0
HANDLE_TOP_RADIUS_TO = 8.0
...
HANDLE_LEFT_CENTER_BULGE = (HANDLE_LEFT_CENTER[0]-HANDLE_SIDE_BULGE_LENGTH, 0, HANDLE_SIDE_BLUGE_HEIGHT)
HANDLE_RIGHT_CENTER = ((BODY_TOP_INSET_EDGE_X_RIGHT + TOP_HOLE_X_RIGHT) * 0.5, 0, HANDLE_BOTTOM)
HANDLE_RIGHT_CENTER_BULGE = (HANDLE_RIGHT_CENTER[0]+HANDLE_SIDE_BULGE_LENGTH, 0, HANDLE_SIDE_BLUGE_HEIGHT)

# x, y, z, center
HANDLE_LEFT = [
    (HANDLE_SIDE_LENGTH, HANDLE_SIDE_WIDTH, HANDLE_BOTTOM, HANDLE_LEFT_CENTER),
    (HANDLE_SIDE_LENGTH, HANDLE_SIDE_WIDTH, HANDLE_SIDE_BLUGE_HEIGHT, HANDLE_LEFT_CENTER_BULGE)
]
HANDLE_TOP = [
    (HANDLE_SIDE_LENGTH, HANDLE_SIDE_WIDTH, HANDLE_TOP_CENTER_HEIGHT, addZ(HANDLE_LEFT_CENTER, HANDLE_TOP_CENTER_HEIGHT), 'r'),
    (HANDLE_TOP_RADIUS_TO, HANDLE_TOP_RADIUS_TO, HANDLE_TOP_CENTER_HEIGHT, addZ(TOP_CENTER, HANDLE_TOP_CENTER_HEIGHT), 'e'), # center
    (HANDLE_SIDE_LENGTH, HANDLE_SIDE_WIDTH, HANDLE_TOP_CENTER_HEIGHT, addZ(HANDLE_RIGHT_CENTER, HANDLE_TOP_CENTER_HEIGHT), 'r'),
]
HANDLE_RIGHT = [
    (HANDLE_SIDE_LENGTH, HANDLE_SIDE_WIDTH, HANDLE_SIDE_BLUGE_HEIGHT, HANDLE_RIGHT_CENTER_BULGE),
    (HANDLE_SIDE_LENGTH, HANDLE_SIDE_WIDTH, HANDLE_BOTTOM, HANDLE_RIGHT_CENTER)
]
